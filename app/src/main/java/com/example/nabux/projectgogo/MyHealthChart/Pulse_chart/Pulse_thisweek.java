...
public class Pulse_thisweek extends Fragment {
    WebView webpulse;
    TextView tvtime,tvavgpulse;
    int pulse_buffer[];

    private static final String htmlurl = "http://www.hth96.me/nabu_connect/pulse/pulse_new.html";
    public static com.example.nabux.projectgogo.MyHealthChart.Pulse_chart.Pulse_thisweek newInstance() {

        com.example.nabux.projectgogo.MyHealthChart.Pulse_chart.Pulse_thisweek fragment = new com.example.nabux.projectgogo.MyHealthChart.Pulse_chart.Pulse_thisweek();


        return fragment;
    }
    public Pulse_thisweek() {

    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.activity_pulse_thisweek, container, false);
        ...
        pulse_buffer = in.getIntArrayExtra("this_pulse_buffer");
